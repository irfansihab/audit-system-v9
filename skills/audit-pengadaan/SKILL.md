...
| 5. | **Analisis Sebab (Kolom Khas Audit)** | Untuk SETIAP temuan substantif, isi kolom Sebab dengan akar masalah administratif/prosedural. Kolom ini WAJIB untuk audit (vs reviu yang tidak butuh). |
| 6. | **Verifikasi kerugian negara** | Untuk temuan terkait pembayaran/kontrak, hitung perkiraan kerugian negara bila relevan (Rp x Volume x Selisih). |
| 7. | **Cek konflik kepentingan** | Bila auditor punya akses data historis pengadaan auditee, cek pola: vendor yang sama berulang kali menang? Pejabat yang sama tanda tangan kontrak besar? |
